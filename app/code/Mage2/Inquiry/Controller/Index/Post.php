...
if(empty($remarks)) {
    $remarks="NaN";
            ...
            $fields = json_encode(array("data" => array(["Last_Name" => $name,"Product_URL" => $product_url,"Lead_Status" => "New","Lead_Source" => $type,"Remarks" => $remarks,"Date_Time" => $currenDateTime,"Email" => $email,"Phone" => $mobile])));
