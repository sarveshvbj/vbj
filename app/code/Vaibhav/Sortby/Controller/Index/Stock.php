        ...
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
                 ...
                 $username = "vaibhav";
                    ...
                    you Gold Luck';*///'your message should be go from here'; // Message text required to deliver on mobile number
                     $message = urlencode('Inventory Updated');
                     $templateId="";
                     $data =
                    "username="."$username"."&password="."$password"."&to="."$numbers"."&from="."$sender"."&msg="."$message"."&type=1"."&template_id="."$templateId";
                    //echo $data;
                    ...
                    $username = "vaibhav";
                     ...
                     /*echo $message = 'Dear Dheeraj Sena, we have received your order no 33359 Circle of Life Rose Gold Pendant, Wish
                    you Gold Luck';*///'your message should be go from here'; // Message text required to deliver on mobile number
                     $message = urlencode('Inventory not Updated');
                      $templateId="";
                     $data =
                    "username="."$username"."&password="."$password"."&to="."$numbers"."&from="."$sender"."&msg="."$message"."&type=1"."&template_id="."$templateId";
                    //echo $data;
