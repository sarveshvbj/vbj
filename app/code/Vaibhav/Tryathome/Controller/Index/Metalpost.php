...
class Metalpost  extends \Magento\Framework\App\Action\Action {
    ...
    $datavalue['source'] = $data['source'];
        ...
        try
        {
           ...
           //Sending Data to API
            ...
            $fields = json_encode(array("data" => array(["Last_Name" => $name,"Product_URL" => $product,"Lead_Status" => "Opportunity","Lead_Source" => $type,"City" => $area,"Date_Time" => $currenDateTime,"Email" => $email,"Phone" => $mobile])));
           ...
           // echo "success";
            ...
            /*
               ...
               $resultRedirect = $this->resultRedirectFactory->create();
                $resultRedirect->setPath('thank-you'); // set this path to what you want your customer to go
                return $resultRedirect;
                /*$customRedirectionUrl = $this->url->getUrl('thank-you'); //Get url of cms page
