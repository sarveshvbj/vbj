 ...
 */
class Codesend extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        //else{
					...
					//$smsMessage = "Your One-Time Password for registering with Vaibhav Jewellers is $token. Kindly Do not share with anyone.";
