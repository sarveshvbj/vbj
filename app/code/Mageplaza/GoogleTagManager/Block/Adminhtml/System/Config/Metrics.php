 ...
 */
class Metrics extends Field
{
    /**
     * @var string
     */
    protected $_template = 'Mageplaza_GoogleTagManager::system/config/metrics.phtml';
    ...
    {
        $values        = [];
        $customMetrics = $this->helperData->getMetrics();
        $options       = $customMetrics ? Data::jsonDecode($customMetrics) : [];
