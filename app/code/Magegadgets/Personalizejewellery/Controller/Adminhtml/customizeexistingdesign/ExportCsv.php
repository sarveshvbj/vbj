...
class ExportCsv extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $fileName = 'personalizejewellery.csv';

        $exportBlock = $this->_view->getLayout()->createBlock('Magegadgets\Personalizejewellery\Block\Adminhtml\Personalizejewellery\Grid');
