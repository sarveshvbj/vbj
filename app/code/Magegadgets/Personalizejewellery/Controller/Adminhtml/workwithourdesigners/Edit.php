...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magegadgets_Personalizejewellery::Personalizejewellery')
            ->addBreadcrumb(__('Magegadgets Personalizejewellery'), __('Magegadgets Personalizejewellery'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Magegadgets\Personalizejewellery\Model\Personalizejewellery');
        ...
        $this->_coreRegistry->register('personalizejewellery', $model);
