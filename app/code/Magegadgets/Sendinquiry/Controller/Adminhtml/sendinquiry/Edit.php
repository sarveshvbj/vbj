...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magegadgets_Sendinquiry::Sendinquiry')
            ->addBreadcrumb(__('Magegadgets Sendinquiry'), __('Magegadgets Sendinquiry'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Magegadgets\Sendinquiry\Model\Sendinquiry');
        ...
        $this->_coreRegistry->register('sendinquiry', $model);
