...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('sendinquiry');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Magegadgets\Sendinquiry\Model\Sendinquiry')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('sendinquiry/*/index');
    }
