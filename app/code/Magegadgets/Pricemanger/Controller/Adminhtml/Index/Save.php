...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
			...
			$UpdateSql = "UPDATE `pricemanager` SET `24K` = '$K24' , `22K` = '$K22' , `18K` = '$K18' , `14K` = '$K14' , `hundred` = '$hundred' , `ninety_two` = '$ninety_two' , `ninety_one` = $ninety_one , `p_hundred` = $p_hundred , `ninety_nine` = $ninety_nine , `ninety_five` = $ninety_five , `usd` = $usd , `tax_customer` = $tax_customer , `tax_business` = $tax_business, `is_updated`= '0' WHERE `pricemanager`.`id` = 1;";  
