...
if(empty($remarks)) {
 ...
 $fields = json_encode(array("data" => array(["Last_Name" => $name,"Product_URL" => $product,"Lead_Status" => "New","Lead_Source" => "Video form","Language" => $language,"Remarks" => $remarks,"Date_Time" => $currenDateTime,"Email" => $email,"Phone" => $mobile])));
