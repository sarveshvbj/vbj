...
class Postnew extends \Magento\Framework\App\Action\Action
{
	...
	public function execute()
    {
		...
		if ($data) {
			...
			/*entry in Lead */
			$data_string = '[{"Attribute":"EmailAddress","Value":"'.$email.'"},{"Attribute":"FirstName","Value":"'.$name.'"},{"Attribute":"Source","Value":"Videoform"},{"Attribute":"Mobile","Value":"'.$mobile.'"},{"Attribute":"Notes","Value":"'.$date.' '.','.$time.' '.','.$language.' '.','.$remarks.' '.','.$product.'"}]';
            try
            {
