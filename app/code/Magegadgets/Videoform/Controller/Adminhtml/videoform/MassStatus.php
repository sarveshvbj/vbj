...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('videoform');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Magegadgets\Videoform\Model\Videoform')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('videoform/*/index');
    }
