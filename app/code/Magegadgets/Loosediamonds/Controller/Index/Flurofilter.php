...
class Flurofilter extends \Magento\Framework\App\Action\Action
{ 
    ...
    public function execute()
    {
		...
		$fluro =  $this->getRequest()->getPostValue('flur');
		...
		if($fluro == 'none'){
			...
			$collection = $StonemanagerFactory->create()->getCollection()->addFieldToSelect('*')
							->addFieldToFilter('fluorescence' , array('like'=>0))->setPageSize(5)->setCurPage($page);
		...
		if($fluro == 'faint'){
			...
			$StonemanagerFactory = $objectManager->get('Magegadgets\Loosediamonds\Model\LoosediamondsFactory');		
			$collection = $StonemanagerFactory->create()->getCollection()->addFieldToSelect('*')
							->addFieldToFilter('fluorescence' , array('like'=>2))->setPageSize(5)->setCurPage($page);
			//print_r($collection->getData());
		...
		if($fluro == 'medium'){
			...
			$StonemanagerFactory = $objectManager->get('Magegadgets\Loosediamonds\Model\LoosediamondsFactory');		
			$collection = $StonemanagerFactory->create()->getCollection()->addFieldToSelect('*')
							->addFieldToFilter('fluorescence' , array('like'=>5))->setPageSize(5)->setCurPage($page);
			//print_r($collection->getData());
		...
		if($fluro == 'strong'){
			...
			$StonemanagerFactory = $objectManager->get('Magegadgets\Loosediamonds\Model\LoosediamondsFactory');		
			$collection = $StonemanagerFactory->create()->getCollection()->addFieldToSelect('*')
							->addFieldToFilter('fluorescence' , array('like'=>7))->setPageSize(5)->setCurPage($page);
			//print_r($collection->getData());
		...
		if($fluro == 'verygood'){
			...
			$StonemanagerFactory = $objectManager->get('Magegadgets\Loosediamonds\Model\LoosediamondsFactory');		
			$collection = $StonemanagerFactory->create()->getCollection()->addFieldToSelect('*')
							->addFieldToFilter('fluorescence' , array('like'=>8))->setPageSize(5)->setCurPage($page);
			//print_r($collection->getData());
